...
//#define NEW_BTN_CABLE	(0)		// 2024/05/27-OLD BUTTON CABLE 
//#define NEW_BTN_CABLE	(1)		// 2024/05/27-NEW BUTTON CABLE 

//#define UNIQ_ENCODER_INVERT (0)		// 24-7-23 해운대 일부 대응. Encoder NG(invert)
//#define UNIQ_ENCODER_INVERT (0)		// 정식

//=== 1-2) IO ENB ======
#define IO_IMU	(1)

//=== Board Type Define
//#define ROD_BOARD_V2	(0)		// V1=Old Rod Board, 
//#define ROD_BOARD_V2	(1)		// V2=New Rod Board

//=== 1-3) DEFINE FUNCTION ENB =================
#define BAT_KAL_FILTER		(0)			// 24/7/10 Delete Kal Filter
#if (!BAT_KAL_FILTER)
	#define BAT_AD_AVG_INTEG	(0)			// 0-AVG, 1-INTERGRATION
	//#define BAT_AD_AVG_INTEG	(1) 		// 0-AVG, 1-INTERGRATION
#endif

//#define NEW_IF		(0)			// IF K20
#define NEW_IF		(1)			// IF K20

#define SLEEP_SET	(0)
#define TEST_ROD_POWER_CONSUMPTION_TEST (0)		// TEST_FW

//#define BDTYPE_DETECT	(1)		// REEL BOARD판별
#define ROD_BDTYPE_DETECT	(0)		// REEL BOARD판별 안함. FIX(V2=NEW)

#define TEST_VRT_MOT	(0)			//REL=0, TEST ROM (xx.xx.xx.60)
//#define TEST_VRT_MOT	(1)			//REL=0, TEST ROM (xx.xx.xx.60)
...
#define BTN_BLUE_PIN		41		// OLD ROD, BT2 = LEFT Button

//#define BTN_SP1_PIN		8		// SPARE_1 BUTTON
//#define BTN_SP2_PIN		9		// SPARE_12BUTTON
...
// MAIN Pin Number
//--- OLD board
#define LED3_R_PIN  		6 		//Red
#define LED2_G_PIN  		7 		//Green
//--- NEW Board
...
// Encoder Pin
#define BTN_PIN   			16		// Encoder Push Button, Not USE
#define DT_PIN    			17		// Encoder A
#define CLK_PIN   			18		// Encoder B
//NEW_ROD, Magnetic Hall Encoder Sensor
...
//--- Board Type
// ROD BOARD TYPE
#define OLD_BOARD_1		0
#define NEW_BOARD_2		1
//--- Break Type
#define BREAK_YES	0	// Exist Break Motor
#define BREAK_NO 	1	// no Break Motor
//--- Button Type
#define BUTTON_V1	0	// BOARD V1 : GPIO5, 41
#define BUTTON_V2	1	// BOARD V2 : GPIO5,4
//-- Enc Type
#define REEL_ENC_V1	0	// BOARD V1 : 2 SIGNAL - 20 Pulse Encoder
#define REEL_ENC_V2	1	// BOARD V2 : 1 SIGNAL - Magnetic Hall Sensor
#define REEL_ENC_V3	2	// BOARD V3 : 1 SIGNAL - Magnetic Hall Sensor	(Vr1.0.1.0)
//---Batt Type
#define BATT_3350_V1	0	// BOARD V1 : 2 SIGNAL - 20 Pulse Encoder
...
#define PID_PWRON_1STCMD	5		// MAIN POWER ON PID, RESP Current STATUS
#define PID_REQ_ROD_INFO	7		// ROD INFO REQ(at AP START), RESP Current STATUS
#define PID_ALIVE_CHK		9
//#define PID_CTRL_NUM		11		// NOT_USE
#define PID_ROD_BREAK		11
#define PID_ROD_IMU_DATA	13

#define PID_VRT_MOT_CONT	19		// VRT MOT
#define PID_BTN_LED_CONT	27		// BTN_LED

#define PID_SLAVE_VER_READ  21		// Version Read

#define PID_ROD_OUT_ALL_OFF  29		//Reel OUT ALL OFF

#define PID_MAIN_ADDR_WRITE	31		// MAIN ADDR Write (MAIN -> ROD)
#define PID_ROD_ADDR_WRITE	32		// OTHER ROD, NOT EXEC(ROD->OTHER ROD)

#define PID_AP_MAIN_INFO	33		//AP,MAIN INFO

//---- SEND PID(STRING)
#define STR_PID_BOARD_TYPE		"02"		// ROD BOARD TYPE
#define STR_PID_ALIVE_RESP		"10"
//#define STR_PID_CTRL_NUM    "11"
//#define STR_IMU_EULER      "13"
//#define STR_IMU_POSITION  "13"			// Not Use
#define STR_PID_IMU_DATA		"14"
#define STR_PID_BUTTON			"16"
#define STR_PID_ENCODE_CNT		"18"
//#define STR_PID_SLAVE_VER_RESP_ROD  "19"	// Version RESP Rod Ver
#define STR_PID_SLAVE_VER_RESP  "22"		// Version RESP, Rod+ IMU
#define STR_PID_IMU_CONN   		"24"		// IMU CONNECT
//#define STR_PID_SLAVE_SLEEP_ENT "22"		// SLAVE SLEEP ENTERENCE
#define STR_PID_BATT_LVL		"26"		// BATT LEVEL
#define STR_PID_ROD_ADDR_WRITE	"32"		// ROD ADDR Write (ROD -> MAIN)

#if (NOT_USE)
#define STR_PID_ROD_INFO_RESP	"34"		// ROD INFO
	// 00 ~02 : Other
	#define IMU_INTERVAL_TIME		"03"		// IMU출력 간격[ms] 0000 ~ 1000 [ms]
#endif
...
//#define LogPrintlnus Serial.printf("%10d us",curr_us_tick);Serial.println
...
//	IMU 인터벌  [ms]
//------------------------------------------
//#define IMU_INTV_MIN_TIME	10	//10ms
...
//#define LOG_IMU_RECV_DATA_OUT	(1)	// for Debug
